...
import com.tex100.webapp.core.model.PermissionInfo;
...
public final class Permissions {
	...
	public static void checkHasPermission(String permissionString) {
		if (!hasPermission(permissionString)) {
			throw new com.tex100.webapp.core.exception.SecurityException(
					com.tex100.webapp.core.exception.SecurityException.SECURITY_NOT_HAS_PERMISSION);
		}
	}
	...
	public static void checkHasRole(String RoleKey) {
		if (!hasRole(RoleKey)) {
			throw new com.tex100.webapp.core.exception.SecurityException(
					com.tex100.webapp.core.exception.SecurityException.SECURITY_NOT_HAS_ROLE);
		}
	}
