...
public abstract class BaseException extends RuntimeException {
	...
	static {
		messageSource.setBasename("com.minyisoft.webapp.core.exception.exceptionMessage");
	}
	...
	public static void setBaseNames(String... baseNames) {
		if (ArrayUtils.isNotEmpty(baseNames)) {
			messageSource.setBasenames((String[]) ArrayUtils.add(baseNames,
					"com.minyisoft.webapp.core.exception.exceptionMessage"));
		}
	}
	...
	public BaseException(Enum<? extends ExceptionCode> exception, Object... params) {
		super(messageSource.getMessage(exception.getClass().getName() + "_" + exception.name(), params, "",
				Locale.getDefault()));
	}
}
