...
public interface BaseService<T extends IModelObject, C extends BaseCriteria> {
	...
	ConcurrentMap<Class<? extends IModelObject>,Class<? extends BaseService<? extends IModelObject, ? extends BaseCriteria>>> MODEL_SERVICE_CACHE = new ConcurrentHashMap<Class<? extends IModelObject>,Class<? extends BaseService<? extends IModelObject, ? extends BaseCriteria>>>();
}
