...
/**
 * @author qingyong_ou Shiro基础Principal
 */
public class BasePrincipal implements Serializable {
	...
	public ISystemOrgObject getSystemOrg() {
		return (ISystemOrgObject) ObjectUuidUtils.getObject(systemOrgId);
	}
	...
	public boolean equals(Object obj) {
		...
		return StringUtils.equals(systemUserId, p.systemOrgId) && StringUtils.equals(systemOrgId, p.systemOrgId);
	}
