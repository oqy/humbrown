...
public enum CachePolicy {
	 ...
	 * before releasing a cached copy. Useful to assure that authentication is
	 * respected (in combination with public), or to maintain rigid freshness,
	 ...
	 * conditions; by specifying this policy, you're telling the cache that you
	 * want it to strictly follow your rules.
	 */
	MUST_REVALIDATE("must-revalidate"),

	/**
	 * Similar to {@link CachePolicy#MUST_REVALIDATE}, except that it only
