...
public class CustomStringToEnumConverterFactory implements
	 ...
	 * 缓存转换器
	 */
	private final ConcurrentMap<Class<? extends Enum>, Converter<String, Enum>> converterCache = Maps.newConcurrentMap(); 
	...
	private static final class StringToDescribableEnum<T extends Enum<? extends DescribableEnum<String>>> implements Converter<String, T> {
